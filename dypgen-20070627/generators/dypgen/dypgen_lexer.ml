...
# 667 "dypgen_lexer.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_ocaml_code_rec lexbuf __ocaml_lex_state
...
# 702 "dypgen_lexer.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; __ocaml_lex_ocaml_type_rec lexbuf __ocaml_lex_state
